...
public class Vision {
    ...
    public Vision (LinearOpMode om) {
        ...
        om.telemetry.addData("Analysis", pipeline.getAnalysis());
        om.telemetry.update();
    ...
    public static class IconPipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input)
        {
            ...
            {
                position = IconPosition.LEFT; // Record our analysis
            ...
            {
                position = IconPosition.CENTER; // Record our analysis
            ...
            {
                position = IconPosition.RIGHT; // Record our analysis
